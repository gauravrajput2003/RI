...
export interface ActivityStatus {state?:VehicleState;last_seen_at?:string|null;status_checked_at?:string;offline_at?:string|null}
export interface Location extends ActivityStatus {id?:string;vehicle_id?:string;tracker_timestamp?:string|null;server_received_at:string;latitude?:number|null;longitude?:number|null;speed?:number|null;course?:number|null;ignition?:boolean|null;satellites?:number|null;gps_valid?:boolean|null;battery_percent?:number|null;gsm_signal?:number|null;state?:VehicleState;metadata?:Record<string,unknown>}
export interface Vehicle extends ActivityStatus {id:string;vehicle_number:string;alias:string|null;vehicle_type:string|null;odometer:number|null;active:boolean;protocol?:string;latestLocation?:Location}
